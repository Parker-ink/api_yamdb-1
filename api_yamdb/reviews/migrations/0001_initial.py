# Generated by Django 2.2.16 on 2022-10-13 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=256)),
                ('year', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1500, 'значение должно быть больше 1500'), django.core.validators.MaxValueValidator(2022, 'значение должно быть меньше текущего года')])),
